...
interface MobileWaterReportFormProps {
  reportData: any;
...
const MobileWaterReportForm: React.FC<MobileWaterReportFormProps> = ({ reportData, handleInputChange, handleSubmit, loading }) => {
  return (
    <div className="space-y-4">
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold text-[#1b4332] mb-2">Water & Infrastructure Report</h2>
        <p className="text-sm text-slate-600">Help improve community water access and maintenance.</p>
      </div>
...
export default MobileWaterReportForm; 